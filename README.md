...
- Privacy-safe contributor-ready backlog: [good first issues](docs/good-first-issues.md)
- Runtime dependency and no-model review boundary: [dependency policy](docs/dependency-policy.md)
