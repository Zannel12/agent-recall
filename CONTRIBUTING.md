...
7. For a versioned public release, follow the [maintainer release checklist](docs/maintainer-release-checklist.md); it does not authorize external publication.
